...
<template>
  <div class="app-shell" :class="{ 'sidebar-collapsed': sidebarCollapsed }" :style="{ '--sidebar-current-width': sidebarWidth + 'px' }">
    ...
    <div class="statusbar">
      ...
      <button class="settings-trigger" @click="settingsCollapsed = false" :title="t('app.openSettings')">
  ...
  <!-- Settings drawer (outside grid) -->
  <Teleport to="body">
    <Transition name="drawer">
      <div v-if="!settingsCollapsed" class="settings-overlay" @click.self="settingsCollapsed = true">
